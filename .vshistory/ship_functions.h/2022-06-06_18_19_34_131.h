...
void force(Ship* s, Position f) {
	...
	float angle_1 = atan2(s->pos.y - f.y, s->pos.x - f.x) - s->pos.a;
	float angle_2 = atan2(s->pos.y - f.y, s->pos.x - f.x) + s->pos.a);
	float angle_3 = atan2(s->pos.y - f.y, s->pos.x - f.x);
	float angle_4 = atan2(s->pos.y - f.y, s->pos.x - f.x) - f.a;
	float angle_5 = atan2(s->pos.y - f.y, s->pos.x - f.x) + f.a;
