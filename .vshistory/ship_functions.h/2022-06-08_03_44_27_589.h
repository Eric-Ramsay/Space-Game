...
void collide(Ship* a, Ship* b) {
	...
	float aF.dx = sin(aF.a) * aF.dy + cos(aF.a) * aF.dx;
	float aF.dy = sin(aF.a) * aF.dx - cos(aF.a) * aF.dy;

	float bF.dx = sin(bF.a) * bF.dy + cos(bF.a) * bF.dx;
	float bF.dy = sin(bF.a) * bF.dx - cos(bF.a) * bF.dy;
