...
void collide(Ship* a, Ship* b) {
	...
	//There are still problems with rotation moving collision zones together and causing stuff to spazz out
	//Also two things moving in the same direction wont collide, instead one will accelerate the other.
}
