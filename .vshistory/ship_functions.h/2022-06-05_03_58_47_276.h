...
void collide(Ship* a, Ship* b) {
	...
	a->pos.dx = Math.cos(angle) * finalxSpeeda + Math.cos(angle + Math.PI / 2) * finalySpeeda
	a->pos.dy = Math.sin(angle) * finalxSpeeda + Math.sin(angle + Math.PI / 2) * finalySpeeda
	b->pos.dx = Math.cos(angle) * finalxSpeedb + Math.cos(angle + Math.PI / 2) * finalySpeedb
	b->pos.dy = Math.sin(angle) * finalxSpeedb + Math.sin(angle + Math.PI / 2) * finalySpeedb
