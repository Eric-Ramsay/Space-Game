...
void moveShip(Ship* s, int r) {
	...
	for (Part& p : s->parts) {
		...
		if (p.crucial) {
			...
			Print(to_str(c), 1920 / 2, a++ * 80 + 1080 / 2, 4);
			Print(to_str(s), 1920 / 2, a++ * 80 + 1080 / 2, 4);
			Print(to_str(x_dif), 1920 / 2, a++ * 80 + 1080 / 2, 4);
			Print(to_str(y_dif), 1920 / 2, a++ * 80 + 1080 / 2, 4);
			Print(to_str(p.x), 1920 / 2, a++ * 80 + 1080 / 2, 4);
			Print(to_str(p.y), 1920 / 2, a++ * 80 + 1080 / 2, 4);
