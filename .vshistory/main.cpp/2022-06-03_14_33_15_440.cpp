...
float halfPoint(float x1, float x2, float m1, float m2) {
	return (x * )
}

void dockShip(Ship* station, Ship* ship) {
	station->cx = (station->cx * station->mass + ship->cx * ship->mass) / (station->mass + ship->mass);
	station->cy = (station->cy * station->mass + ship->cy * ship->mass) / (station->mass + ship->mass);
	ship->cy = (station->cy * station->mass + ship->cy * ship->mass) / (station->mass + ship->mass);
	ship->cy = (station->cy * station->mass + ship->cy * ship->mass) / (station->mass + ship->mass);
	station->pos.da = 
	station->pos.dx
	station->pos
