...
void force(Ship* s, Position f) {
	...
	float angle2 = atan2(s->pos.y - f.y, s->pos.x - f.x) + s->pos.angle;
	float angle3 = atan2(s->pos.y - f.y, s->pos.x - f.x);
	float angle4 = atan2(s->pos.y - f.y, s->pos.x - f.x) - f.a;
	float angle5 = atan2(s->pos.y - f.y, s->pos.x - f.x) + f.a;
