...
bool bounded(Part p1, Position ship1, Part p2, Position ship2) {
	...
	bool top_left = bounded(p1, ship1, part.tl.x, part.tl.y);
	bool top_right = 

	return  || bounded(p1, ship1, part.tr.x, part.tr.y) || bounded(p1, ship1, part.bl .x, part.bl.y) || bounded(p1, ship1, part.br.x, part.br.y);
}
