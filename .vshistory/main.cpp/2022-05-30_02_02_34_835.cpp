...
bool overlap(Position& a, Position& b, int size = 8) {
...
int main() {
    ...
    while (window.isOpen()) {
		...
		Print(to_str((int)player.cy), view.getCenter().x - 50, view.getViewPort().y + 20, zoom;
		Print(to_str((int)player.cx), view.getCenter().x + 50, view.getViewPort().y + 20, zoom);
        window.display();
    }
