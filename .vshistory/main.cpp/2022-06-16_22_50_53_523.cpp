			...
			if (!in_shipyard) {
				for (Part p : player->parts) {
					if (p.crucial) {
						...
						Print("X Min: " + to_str((int)(player->pos.x)), player->pos.x + 50, player->pos.y - 25);
						Print("Y Min: " + to_str((int)(player->pos.y)), player->pos.x + 50, player->pos.y + 25);
						Print("X Max: " + to_str((int)(player->pos.x)), player->pos.x + 50, player->pos.y - 25);
						Print("Y Max: " + to_str((int)(player->pos.y)), player->pos.x + 50, player->pos.y + 25);
					}
				}
