...
void dock(Ship* ship, Ship* station) {
	...
	station->pos.x = half(station->pos.x, ship->x, station->mass, ship->mass);
	station->y = half(station->y, ship->y, station->mass, ship->mass);

	ship->x = half(station->cx, ship->cx, station->mass, ship->mass);
	ship->y = half(station->cy, ship->cy, station->mass, ship->mass);
