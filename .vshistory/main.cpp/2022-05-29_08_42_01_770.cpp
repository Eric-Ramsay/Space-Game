...
int main() {
    ...
    while (window.isOpen()) {
		...
		Print(to_str((int)player.cy), view.getCenter().x, view.getCenter().y - view.getSize().y * .4);
		Print(to_str((int)player.cx), view.getCenter().x, view.getCenter().y - view.getSize().y * .4);
        window.display();
    }
