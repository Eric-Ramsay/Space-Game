...
void collide(Ship* a, Ship* b) {
	...
	a->pos.dx = cos(angle) * aX + cos(angle + Math.PI / 2) * finalySpeeda
	a->pos.dy = sin(angle) * aX + sin(angle + Math.PI / 2) * finalySpeeda
	b->pos.dx = cos(angle) * bX + cos(angle + Math.PI / 2) * finalySpeedb
	b->pos.dy = sin(angle) * bX + sin(angle + Math.PI / 2) * finalySpeedb
