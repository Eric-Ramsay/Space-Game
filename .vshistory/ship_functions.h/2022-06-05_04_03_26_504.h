...
void collide(Ship* a, Ship* b) {
	...
	a->pos.dx = cos(angle) * aX + cos(angle) * finalySpeeda
	a->pos.dy = sin(angle) * aX + sin(angle) * finalySpeeda
	b->pos.dx = cos(angle) * bX + cos(angle) * finalySpeedb
	b->pos.dy = sin(angle) * bX + sin(angle) * finalySpeedb
