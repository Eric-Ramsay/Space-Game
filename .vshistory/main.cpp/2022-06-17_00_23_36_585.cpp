			...
			if (!in_shipyard) {
				for (Part p : player->parts) {
					if (parts[p.i].crucial) {
						...
						Print("X Min: " + to_str(((int)(x_min * 10))), player->pos.x - 50, player->pos.y - 25);
						Print("Y Min: " + to_str(((int)(y_min * 10))), player->pos.x - 50, player->pos.y + 25);
						Print("X Max: " + to_str(((int)(x_max * 10))), player->pos.x + 50, player->pos.y - 25);
						Print("Y Max: " + to_str(((int)(y_max * 10))), player->pos.x + 50, player->pos.y + 25);
					}
				}
				Print(to_str(((int)(mX * 10))), mX, mY - 10);
				Print(to_str(((int)(mY * 10))), mX, mY + 10);
