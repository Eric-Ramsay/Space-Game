...
struct Part {
	...
	Part(std::string n, int dura, int x, int y) {
		name = n;
		durability = dura;
	}
};
...
std::vector<Part> initParts() {
	Part command_module;
	command_module.name = "Command Module";
	command_module.durability = 25;
	command_module.crucial = true;
