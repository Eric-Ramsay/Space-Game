...
struct UI_Part {
	...
	UI_Part(std::string n = "Nothing", short w1 = 16, short h1 = 16, short offY = 0, int dura = 25, float m1 = 25, Connection c = Connection(true, false, false, false), bool cruc = false, float t1 = 0) {
		name = n;
		durability = dura;
		connects = c;
		crucial = cruc;
