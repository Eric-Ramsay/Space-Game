...
void drawSprite(int sX, int sY, int w, int h, int dX, int dY, int scale = zoom, sf::Color color = sf::Color::White) {
...
int main() {
    ...
    while (window.isOpen()) {
        ...
        window.clear();
        drawSprite(8 * 16, 16 + (timer % 6) * 32, 16, 32, 10, 10);
        drawSprite(8 * 16, 16 + (timer % 6) * 32, 16, 32, 100, 200);
        window.display();
    }
