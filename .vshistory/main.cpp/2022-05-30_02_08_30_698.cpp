...
int main() {
    ...
    while (window.isOpen()) {
		...
		Print(to_str((int)player.cy), view.getCenter().x - 50, view.getCenter().y - view.getSize().y/2.0);
		Print(to_str((int)player.cx), view.getCenter().x + 50, view.getCenter().y - view.getSize().y/2.0);
        window.display();
    }
