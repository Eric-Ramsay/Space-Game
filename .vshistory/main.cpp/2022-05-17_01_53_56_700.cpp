...
s			player.x = fmod(player.x + cos(player.angle) * player.velocity, 1920);
			player.y = fmod(player.y + sin(player.angle) * player.velocity, 1080);
		...
		drawSprite(240, 16, 14, 13, player.x, player.y, 4, 90 + player.angle);
        window.display();
    }
