...
bool bounded(Part p1, Position ship1, Part p2, Position ship2) {
	...
	return bounded(p1, ship1, part.tl.x, part.tl.y) || bounded(p1, ship1, part.tl.x, part.tl.y) || bounded(p1, ship1, part.tl.x, part.tl.y) || bounded(p1, ship1, part.tl.x, part.tl.y) || ;
}
